...
lin
  ...
  i_Pron = {s="nyowe"; agr = AgMUBAP1 Sg};
  youSg_Pron = {s="iwe"; agr=AgMUBAP2 Sg };
  she_Pron = {s="uwe"; agr=AgP3 Sg MU_BA};
  he_Pron = {s="uwe"; agr=AgP3 Sg MU_BA};
  it_Pron = {s="kyo"; agr=AgP3 Sg KI_BI}; -- should form an it_Pron_NClass in extra module
  we_Pron = {s="itwe"; agr = AgMUBAP1 Pl};
  youPl_Pron ={s="imwe"; agr = AgMUBAP2 Pl};
  they_Pron = {s="bo"; agr=AgP3 Pl MU_BA};--But there are lots of other representations from other noun classes in extra module
