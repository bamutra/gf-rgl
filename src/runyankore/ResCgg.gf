...
oper
  ...
  mkNCParticles : ParticleForms  = table {
      ...
      -- Genetive Adjective suffixes used to form genetive adjectives when conjugated to the genetive prepositions particles
      -- examples: ekya-{ngye}= my own or mine, ekya-{itu}= our own or ours, ekya-{we}-your own or yours 
      GenAdj => table { 
              AgMUBAP1 Sg => "ngye";
              AgMUBAP1 Pl => "itu";
              AgMUBAP2 Sg => "we";
  ...
  mkDeterminer: Determiner -> Noun -> NounPhrase = \det, cn ->
    case det.pos of{ 
                     ...
                     PostDeterminer=>{s = cn.s!det.ntype!det.num ++ mkNCParticles!SubjM!AgP3 det.num cn.nc ++ det.s; agr = AgP3 det.num cn.nc}
                   };
  ...
  smartNoun : Str -> NClass -> Noun 
    = \omuntu, g ->
      case <omuntu,g> of {
        ...
        <"o" + "mwa" + stem, MU_BA> => mkNoun omuntu ("aba" + stem) g ; --same as mu_ba but the "u" + "a" of the stem to form mwa  
        <"o" + "mwo" + stem, MU_BA> => mkNoun omuntu ("abo" + stem) g ; --same as mu_ba but the "u" + "o" of the stem to form mwo
        <"o" + "mwi" + stem, MU_BA> => mkNoun omuntu ("abi" + stem) g ; --same as mu_ba but the "u" + "i" of the stem to form mwi
        <"o" + "mu" +  stem, MU_MI> => mkNoun omuntu ("emi" + stem) g ;
        <"o" + "ru" +  stem, RU_MA> => mkNoun omuntu ("ama" + stem) g ;
        <"o" + "ru" +  stem, RU_N>  => mkNoun omuntu ("end" + stem) g ;
        <"e" + "ki" + stem, KI_BI> => mkNoun omuntu ("ebi" + stem) g ;
        <"e" + "i" + stem, I_MA> => mkNoun omuntu ("ama" + stem) g ;
        -- --special case when
        <"e" + "ky" + stem, KI_BI> => mkNoun omuntu ("eby" + stem) g ; 
